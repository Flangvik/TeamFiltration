...
namespace TeamFiltration
{
    ...
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            //args = new string[] { "--help" };
           // args = new string[] { "--outpath", @"F:\Clients\Debug Engagments\Legitcorp\", "--exfil", "--owa", "--cookie-dump", @"F:\Clients\Debug Engagments\Legitcorp\CookieDump.txt", "--debug" };
         //   args = new string[] { "--outpath", @"F:\Clients\Debug Engagments\Legitcorp\TeamFil\", "--enum", "--dehashed","--domain", "trustedsec.com"};
